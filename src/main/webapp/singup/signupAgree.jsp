...
<html>
    ...
    <body>
        <h2>회원가입</h2>
    <form id="termsForm" action="signup_form.jsp" method="post">
        <h3>서비스 약관 동의</h3>
        <p>서비스 약관 동의 (필수)</p>
        <textarea rows="8" cols="60" readonly>
제1조 (목적)
이 약관은 밀리로드(Milli Road)(이하 "회사"라 한다.)이 운영하는 웹사이트에서 제공하는
인터넷 가입자 관련 서비스(이하 "서비스"라 한다.)를 이용함에 있어, 회사와 회원 간의
...
제3조 (약관의 명시 및 변경)
① 회사는 이 약관의 내용을 회원이 쉽게 알 수 있도록 서비스 초기 화면 또는 연결화면에
게시합니다.
② 회사는 관련 법령을 위배하지 않는 범위에서 이 약관을 변경할 수 있습니다.
        ...
        <hr>
        <h3>위치 기반 서비스 약관 동의</h3>
        <p>위치 기반 서비스 약관 동의 (필수)</p>
        <textarea rows="8" cols="60" readonly>
제1조 (목적)
본 약관은 밀리로드(Milli Road)(이하 "회사"라 한다.)가 제공하는 위치정보 기반 서비스
(이하 "위치기반 서비스"라 한다.)를 이용함에 있어 회사와 회원의 권리, 의무 및 책임,
...
요구할 수 있습니다.
    ...
    <script>
        ...
        // 폼 전송 시(다음 버튼 클릭 시) 검사
        termsForm.addEventListener("submit", function (e) {
            // 둘 중 하나라도 체크 안 되어 있으면 막기
            if (!chkService.checked || !chkLocation.checked) {
                e.preventDefault(); // 폼 제출 막기
                alert("필수 약관에 모두 동의해 주세요.");
            }
            // 둘 다 체크되어 있으면 그대로 signup_form.jsp로 넘어감
        });
    </script>
    </body>
</html>
