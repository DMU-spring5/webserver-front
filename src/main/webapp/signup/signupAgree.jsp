...
제1조 (목적)
이 약관은 웹서비스 5조(이하 "운영자"라 한다)이 운영하는 Milli Road(이하 "웹사이트"라 한다)에서 제공하는 인터넷 기반의 군대 관련
AI 뉴스 크롤링(이하 "서비스"라 한다)을 이용과 관련하여, 운영자와 회원 간의 권리, 의무 및 책임사항을 규정함을 목적으로 합니다.

제2조 (용어의 정의)
① "회원"이라 함은 회사의 서비스에 접속하여 이 약관에 따라 회사와 이용계약을 체결하고, 회사가 제공하는 서비스를 이용하는 자를 말합니다.
② "아이디(ID)"라 함은 회원의 식별과 서비스 이용을 위하여 회원이 정하고 회사가 승인하는 문자와 숫자의 조합을 말합니다.
③ "비밀번호"라 함은 회원이 부여받은 아이디와 일치되는 회원임을 확인하고, 회원의 개인정보 보호를 위하여 회원 자신이 정한 문자와 숫자의 조합을 말합니다.
...
② 회사는 관련 법령을 위배하지 않는 범위에서 이 약관을 변경할 수 있습니다.
            ...
            <h3>위치기반 서비스 약관 동의 (필수)</h3>
            <textarea rows="8" cols="60" readonly style="resize:none;">
제1조 (목적)
본 약관은 위치정보를 이용하여 제공되는 Milli Road의 위치기반 서비스(이하 "위치기반서비스"라 한다)를 이용함에 있어, 운영자와 회원
...
② 회원은 회사에 대하여 보유하고 있는 자신의 위치정보에 대한 열람 또는 오류정정을 요구할 수 있습니다.
                    </textarea>
            <br>
